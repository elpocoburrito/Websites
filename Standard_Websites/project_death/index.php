...
<head>
	...
	<meta property="og:description" content="Linuks, Home to all my school projects!">
	<title>Linuks</title>
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="./mains.php">Page 1</a></li>
...
-->
  <div class="container-fluid">
    <div class="row">
      <div id="SideNavID" class="col-md-3 col-sm-3 col-xs-3">
        <a href="#">About</a>
        <a href="#">Services</a>
        <a href="#">Clients</a>
        <a href="#">Contact</a>
      </div>
      <div id="main" class="col-md-9 col-sm-9 col-xs-9">
        <iframe
        src="http://player.twitch.tv/?channel=Alderiate"
        height="100%"
        width="100%"
        frameborder="0"
        scrolling="no"
